...
<body>
    ...
    <div class="content-wrapper">
        <div class="container loginbox">
            ...
            <div class="row">
                <div class="col-md-6">
                        <input type="text" name="regno" class="form-control" placeholder="Enter your Login Id"/>
                        <input type="password" name="password" class="form-control" placeholder="Enter Password"/>
                        <button type="submit" name="submit" class="btn btn-info login1"><span class="glyphicon glyphicon-user"></span> &nbsp;Log Me In </button>&nbsp;
                </div>
                </form>
