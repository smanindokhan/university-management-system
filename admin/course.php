...
if ( strlen( $_SESSION['alogin'] ) == 0 ) {
    ...
    if ( isset( $_POST['submit'] ) ) {
        ...
        ////////////////////////////////////////////////
        $dup = mysqli_query( $con, "select * from course where coursecode ='$coursecode'" );
        if (mysqli_num_rows( $dup )>0){
            $_SESSION['msg'] = "Course is already added!!!";
        }
        else{
        //////////////////////////////////////////////
        
            $ret = mysqli_query( $con, "insert into course(courseCode,courseName,prerequisite,noofSeats) values('$coursecode','$coursename','$prerequisite','$seatlimit')");
                            ...
                            <div class="panel-body">
                               ...
                               <!-- <div class = "form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="prerequisite" name="prerequisite" placeholder="Prerequisite Course" required />
                                    </div>
